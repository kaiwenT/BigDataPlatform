...
import com.hust.automaticrating.utils.ExcelReader;
 ...
 *
 */
public class GetScoreOfClassification {
	...
	static {
		try {
			File file = new File(GetScoreOfClassification.class.getResource("/bayesdata/bayesdata.txt").getPath());
	...
	public int getTotalResult(String expId, String stuId) {
		String taskPath = Constant.DIRECTORY.EXPERIMENT_DATA_SUBMIT + expId + "/" + stuId + "/";
		try {

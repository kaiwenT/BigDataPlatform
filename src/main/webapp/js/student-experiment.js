				...
				if(exps != 'undefined' && exps != '' && exps.length > 0){
					...
					$.each(exps, function(idx, exp){
						...
						var titlebox = '<div><div class="titleBox j-titleBox f-cb" id="'+exp.experimentId+'" onclick="titleClick(this)">'
							...
							+'<div class="exp-box"><div class="exp-source exp-video f-pr"><div class="f-pr f-fl source-sign">'
							+'<span class="u-icon-video2" style="font-size: 20px;margin: -10px -10px; top:50px; left:50%;position: relative; "></span></div>'
							+'<div class="source-box"><div class="f-pr f-fl source-video"><div class="video-play" style="">'
							+'<span class="u-icon-video" style="font-size: 40px;margin: -20px -20px; top:50%; left:50%;position: absolute; "></span></div></div>'
							+'<div class="f-pr f-fl source-video"><div class="video-play" style="">'
							+'<span class="u-icon-video" style="font-size: 40px;margin: -20px -20px; top:50%; left:50%;position: absolute; "></span></div></div></div></div>'
							...
							+'<div class="source-box"><div class="f-pr f-fl source-pdf"><div class="pdf-view" style="">'
							+'<span class="u-icon-book" style="font-size: 40px;margin: -20px -20px; top:50%; left:50%;position: absolute; "></span></div></div>'
							+'<div class="f-pr f-fl source-pdf"><div class="pdf-view" style="">'
							+'<span class="u-icon-book" style="font-size: 40px;margin: -20px -20px; top:50%; left:50%;position: absolute; "></span>'
